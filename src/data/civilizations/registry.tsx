...
import {CivilizationBonus} from '../core';
import {UniqueTechnology} from '../technologies/core';
import {
  Atlatl,
  Kasbah,
  Yeomen,
...
export interface Civilization {
  ...
  uniqueTechnologies: UniqueTechnology[];
  baseImg: string;
  hoverImg: string;
  pressedImg: string;
  url: string;
...
export const Aztecs: Civilization = {
  ...
  uniqueTechnologies: [Atlatl, GarlandWars],
  baseImg: aztecs,
...
export const Berbers: Civilization = {
  ...
  uniqueTechnologies: [Kasbah, MaghrabiCamels],
  baseImg: berber,
...
export const Burmese: Civilization = {
  ...
  uniqueTechnologies: [Howdah, ManipurCavalry],
  baseImg: burmese,
...
export const Byzantines: Civilization = {
  ...
  uniqueTechnologies: [GreekFire, Logistica],
  baseImg: byzantines,
...
export const Celts: Civilization = {
  ...
  uniqueTechnologies: [Stronghold, FurorCeltica],
  baseImg: celts,
  hoverImg: celtsHover,
...
export const Chinese: Civilization = {
  ...
  uniqueTechnologies: [GreatWall, Rocketry],
  baseImg: chinese,
...
export const Cumans: Civilization = {
  ...
  uniqueTechnologies: [SteppeHusbandry, CumanMercenaries],
  baseImg: cumans,
...
export const Ethiopians: Civilization = {
  ...
  uniqueTechnologies: [RoyalHeirs, TorsionEngines],
  baseImg: ethiopians,
...
export const Franks: Civilization = {
  ...
  uniqueTechnologies: [Chivalry, BeardedAxe],
  baseImg: franks,
...
export const Incas: Civilization = {
  ...
  uniqueTechnologies: [AndeanSling, Couriers],
  baseImg: inca,
  hoverImg: incaHover,
...
export const Italians: Civilization = {
  ...
  uniqueTechnologies: [Pavise, SilkRoad],
  baseImg: italians,
...
export const Khmer: Civilization = {
  ...
  uniqueTechnologies: [TuskSwords, DoubleCrossbow],
  baseImg: khmer,
  hoverImg: khmerHover,
...
export const Magyars: Civilization = {
  ...
  uniqueTechnologies: [Mercenaries, RecurveBow],
  baseImg: magyars,
...
export const Malay: Civilization = {
  ...
  uniqueTechnologies: [Thalassocracy, ForcedLevy],
  baseImg: malay,
  hoverImg: malayHover,
...
export const Mayans: Civilization = {
  ...
  uniqueTechnologies: [ObsidianArrows, ElDorado],
  baseImg: mayans,
...
export const Tatars: Civilization = {
  ...
  uniqueTechnologies: [SilkArmor, TimuridSiegecraft],
  baseImg: tatars,
...
export const Vietnamese: Civilization = {
  ...
  uniqueTechnologies: [Chatras, PaperMoney],
  baseImg: vietnamese,
